...
| الصفحة | المسار | الحالة | ملاحظات |
|--------|--------|--------|---------|
| قائمة المنح الدراسية | `/scholarships` | ⚠️ قيد التنفيذ | تحتاج تعديل بناءً على المخطط الجديد |
| تفاصيل المنحة الدراسية | `/scholarships/[slug]` | ⚠️ قيد التنفيذ | تحتاج تعديل بناءً على المخطط الجديد |
| البحث عن منح | `/scholarships/search` | ❌ لم يبدأ | |
...
| المنح الدراسية | `/api/scholarships` | ❌ لم يبدأ | |
| تفاصيل منحة | `/api/scholarships/[slug]` | ❌ لم يبدأ | |
