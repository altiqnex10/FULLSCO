...
- [ ] ترحيل مكون البحث
- [ ] ترحيل مكون بطاقة المنحة (ScholarshipCard)
- [ ] ترحيل مكون التنقل بين الصفحات (Pagination)
- [ ] ترحيل مكونات التصفية والفرز

### المرحلة 3: ترحيل الصفحات العامة

- [x] ترحيل الصفحة الرئيسية
- [x] ترحيل صفحة 404
- [ ] ترحيل صفحة المنح الدراسية
- [ ] ترحيل صفحة تفاصيل المنحة
